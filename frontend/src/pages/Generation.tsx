    ...
    <div className="daily-editorial-page flex h-screen flex-col bg-white text-slate-900 dark:bg-background-dark dark:text-white">
      <div className="daily-editorial-topbar flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-slate-200 dark:border-border-dark px-4 sm:px-6 py-4">
        ...
        <div className="daily-editorial-actions flex flex-wrap items-center gap-2 sm:gap-3 bg-white dark:bg-surface-dark p-1.5 rounded-lg border border-slate-200 dark:border-border-dark shadow-sm w-full sm:w-auto">
          ...
          <button 
            ...
            className="daily-ink-button flex-1 sm:flex-none flex items-center justify-center gap-2 rounded bg-primary hover:bg-cyan-400 disabled:bg-slate-400 transition-colors text-white dark:text-surface-darker text-sm font-bold px-4 py-1.5 shadow-lg shadow-primary/20"
          >
            {generating ? (
      ...
      <div className="daily-editorial-shell flex-1 grid grid-cols-1 lg:grid-cols-[240px_minmax(0,1fr)_220px] 2xl:grid-cols-[260px_minmax(0,1fr)_240px] min-h-0 overflow-hidden bg-white dark:bg-background-dark">
        ...
        <div className="daily-editorial-main flex flex-col min-w-0 min-h-0">
          <div className="daily-doc-toolbar flex items-center justify-between px-3 sm:px-4 py-2 h-12 border-b border-slate-200 dark:border-border-dark bg-slate-100 dark:bg-surface-darker shrink-0 overflow-x-auto no-scrollbar">
      ...
      {/* Footer Actions */}
      <div className="daily-editorial-footer flex flex-col sm:flex-row items-center justify-between bg-white dark:bg-surface-darker px-4 sm:px-6 py-3 border-t border-slate-200 dark:border-border-dark gap-3 sm:gap-0">
        {/* Mobile Tab Switcher */}
        <div className="flex lg:hidden w-full items-center gap-2 bg-slate-100 dark:bg-surface-dark rounded-lg p-2 border border-slate-200 dark:border-border-dark">
        ...
        <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
          ...
          <button 
            ...
            className="daily-ink-button flex-[1.5] sm:flex-none flex items-center justify-center gap-2 px-4 sm:px-5 py-2 rounded-lg bg-primary hover:bg-cyan-400 disabled:bg-slate-400 text-white font-bold transition-all shadow-lg shadow-primary/20 text-sm sm:text-base"
          >
            {committing ? (
