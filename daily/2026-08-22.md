...
1. **[Antigravity IDE Extensions - “反重力”代理现已集成到您现有的编辑器中](https://www.producthunt.com/r/OJKMMDRQ54XCDO)**
...
2. **[fx (by Vercel) - Vercel 的微型开源编程助手](https://www.producthunt.com/r/65726O3N7WO5MO)**
...
3. **[Epho - 在云端运行 Claude Code、Codex 或 Opencode，并使用您的代码仓库](https://www.producthunt.com/r/YWZHF6R3TSHJHT)**
...
4. **[Mindcase - 几分钟内即可从网络上的任何地方提取数据](https://www.producthunt.com/r/YI6XZOPMLJBZWC)**
...
5. **[Supernova - 您在 Claude 和 Codex 中的所有数据](https://www.producthunt.com/r/NI5US6CC4XM5FB)**
...
6. **[Wizstar - 动作和表现都像专业演员一样的数字虚拟形象](https://www.producthunt.com/r/66CCQDPHMOWPG6)**

   Digital avatars that move and act like professional actors (www.producthunt.com) 08-21 PH Link

   ![Wizstar - 动作和表现都像专业演员一样的数字虚拟形象](/daily-assets/2026-08-22/product-hunt-daily-product-hunt-buzzing-ihyk-5s06b20orkffjqq.avif)

   来源：Product Hunt Daily

7. **[Aloud - 将语音反馈转换为编码代理可执行的任务](https://www.producthunt.com/r/AOIGYVQTYHCPRE)**

   Turn spoken feedback into tasks your coding agent can run (www.producthunt.com) 08-20 ↑ 118 PH Upvotes

   ![Aloud - 将语音反馈转换为编码代理可执行的任务](/daily-assets/2026-08-22/product-hunt-daily-product-hunt-buzzing-zeuhwtu4apbwmxo9d0ic.avif)

   来源：Product Hunt Daily

8. **[MiniMax Design - 专属于您的代理团队，助您自由创作](https://www.producthunt.com/r/3ZDKIA2BDBRV7U)**
...
9. **[Hermai Brand API - 根据每位客户的品牌，为您的 B2B SaaS 提供白标服务](https://www.producthunt.com/r/KBTDPMY6V3G6LL)**

   White label your B2B SaaS with every customer''s brand (www.producthunt.com) 08-20 ↑ 133 PH Upvotes

   ![Hermai Brand API - 根据每位客户的品牌，为您的 B2B SaaS 提供白标服务](/daily-assets/2026-08-22/product-hunt-daily-product-hunt-buzzing-scx0-f9qgdp8pkm-ei4u.avif)

   来源：Product Hunt Daily

10. **[Lifelong - 全家的健康状况，尽在一处。](https://www.producthunt.com/r/EMHDXTAKNXV56T)**
...
1. **[santifer/career-ops](https://github.com/santifer/career-ops)**
   ...
   Open-source AI job search: scan job portals, evaluate listings with a structured A-F rubric into a 1.0-5.0 score, tailor your CV, track applications — runs locally in your AI coding CLI (Claude Code, Codex, OpenCode, Antigravity…) Language: JavaScript Stars: 67423 Forks: 12867
...
2. **[cursor/plugins](https://github.com/cursor/plugins)**
   ...
   Cursor plugin specification and official plugins Language: TypeScript Stars: 4384 Forks: 366
...
3. **[modular/modular](https://github.com/modular/modular)**
   ...
   The Modular Platform (includes MAX & Mojo) Language: Mojo Stars: 28671 Forks: 3053
...
4. **[mattpocock/skills](https://github.com/mattpocock/skills)**
   ...
   Skills for Real Engineers. Straight from my .agents directory. Language: Shell Stars: 229389 Forks: 19604
...
5. **[mahlernim/google-timeline-visualizer](https://github.com/mahlernim/google-timeline-visualizer)**
   ...
   Visualize your year in travel using your Google Location History (Timeline) data Language: Kotlin Stars: 2204 Forks: 252
...
6. **[harry0703/MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo)**
   ...
   利用 AI 大模型和自动化工作流，根据主题或关键词一键生成高清短视频。Generate HD short videos from a topic or keyword with an automated AI workflow. Language: Python Stars: 113864 Forks: 17277
...
7. **[AprilNEA/OpenLogi](https://github.com/AprilNEA/OpenLogi)**
   ...
   ⚡️A native, local-first alternative to Logitech Options+, written in Rust 🦀 — remap buttons, DPI, and SmartShift over HID++. No account, no telemetry. Language: Rust Stars: 12879 Forks: 349
...
9. **[microsoft/TypeScript](https://github.com/microsoft/TypeScript)**
   ...
   TypeScript is a superset of JavaScript that compiles to clean JavaScript output. Language: Go Stars: 110371 Forks: 13740
...
10. **[obra/superpowers](https://github.com/obra/superpowers)**
   ...
   An agentic skills framework & software development methodology that works. Language: Shell Stars: 275638 Forks: 24642
...
7. **[Anubis continues to expose new ways people configure webservers](https://xeiaso.net/notes/2026/anubis-csp-worker-hell/)**
   ...
   ![Anubis continues to expose new ways people configure webservers](/daily-assets/2026-08-22/xe-iaso-xe-iaso-nmcvxlzbs7mqv4ob-bdo.webp)
